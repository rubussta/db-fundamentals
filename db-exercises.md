...
<details>
<summary>Упражнение 5.1 (Групповые политики)</summary>
...
<details>
<summary>Упражнение 5.2 (Групповые политики)</summary>
...
<details>
<summary>Упражнение 5.3 (Групповые политики)</summary>
...
```SQL
demo=# -- В одной колонке преобразуем простое скалярное значение в json, в другой – возвратим json-объект из списка аргументов.
demo=# SELECT to_json (model) AS json_simple, json_build_object ('model' , model , 'range' , range) FROM aircrafts;
